...
try:
    voltage_data = np.loadtxt('measure---1.txt')
...
experiment_duration = 30  # секунды
conversion_factor = 0.4  # коэффициент преобразования напряжения в высоту
...
plt.xlabel("Время (с)")
plt.ylabel("Высота уровня воды (ед.)")
