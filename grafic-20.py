...
try:
    voltage_data = np.loadtxt('20-spusk.txt')
...
experiment_duration = 10  # секунды
conversion_factor = 0.6  # коэффициент преобразования напряжения в высоту
...
plt.xlabel("Время (с)")
plt.ylabel("Высота уровня воды (vм)")
